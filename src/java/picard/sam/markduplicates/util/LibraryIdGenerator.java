...
public class LibraryIdGenerator {
    ...
    public Histogram<Short> getOpticalDupesByLibraryIdMap() { return this.opticalDupesByLibraryId; }
    ...
    public short getLibraryIdFromRecord(final SAMRecord rec) {
    ...
    public long getNumberOfOpticalDuplicateClusters() {
        return (long)this.opticalDupesByLibraryId.getSumOfValues();
    }
}
